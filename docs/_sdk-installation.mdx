1. Install [nilup](/nilup), the [Nillion SDK tool](/nillion-sdk-and-tools#nillion-sdk-tools) installer and version manager. Binaries are available for [Linux and macOS platforms](/limitations#platforms). For Windows installation, follow our [Windows installation guide.](/installation#windows-guide)
