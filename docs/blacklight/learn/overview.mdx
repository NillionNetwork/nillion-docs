...
Blacklight L1 is on **testnet only** for now, deployed to Ethereum Sepolia. You can already [run a node](/blacklight/l1/run-a-node), [get testnet NIL](/blacklight/l1/faucet), and [build with the SDK](/blacklight/l1/sdk).

:::

:::warning This network will be deprecated
