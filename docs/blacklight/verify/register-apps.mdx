...
nilCC is Nillion's Confidential Compute platform. To register a nilCC workload for verification, you need to have a nilCC API key. You can get a nilCC API key by subscribing to nilCC on the [nilCC Workload Manager](https://nilcc.nillion.com).
