...
Each [nilAI node](/blind-computer/build/network-config#nilai-nodes) API provides the following endpoints for interfacing with [Private LLMs](/blind-computer/build/llms/overview):
