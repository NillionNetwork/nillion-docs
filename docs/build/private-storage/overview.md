...
- Get [Nillion Network Access](/build/network-api-access) to connect to nilDB nodes
...
Learn more about the key concepts [here](/build/private-storage/key-concepts)