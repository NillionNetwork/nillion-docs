...
After adding in the extra files, push the latest changes to main. Then we can now run the Github (GH) Action Bot by tagging the version
...
Then we can add your public `verification-manifest.json` from your Github Repo to the `Github URL` input box. You will receive a `React/JSX` Code Snippet to use on your site. 

Then you can embed it like this example site: [https://nilcc-attestation-example.vercel.app/](https://nilcc-attestation-example.vercel.app/)