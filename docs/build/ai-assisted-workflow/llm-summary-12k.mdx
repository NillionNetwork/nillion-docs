...
- Overview / About
  ...
  - Architecture
  - What are Blind Modules (nilDB and nilAI)
...
- `Gemma 27B`: For multimodal tasks (text + images), high-performance reasoning, multilingual support.
- `GPT OSS 20B`: For agentic workflows, chain-of-thought reasoning, tool use.
- `LLama 8B`: For general-purpose tasks, resource-efficient deployment, prototyping on consumer hardware.
...
// apiKey is your nilAI node api key: https://docs.nillion.com/build/private-llms/quickstart
