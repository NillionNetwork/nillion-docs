...
<Tabs>
  <TabItem value='nucs-flow' label='NUCS'>
    ...
    In order to get an API Key, you must have a nillion address. We recommend starting by following the [wallet setup guide](/community/guide-nillion-wallet) to get started.
