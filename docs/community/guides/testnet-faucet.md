...
## How to use the nilChain Testnet Faucet

This guide walks you through how to get NIL from the nilChain Testnet Faucet.
...
Follow the [Creating a Nillion Wallet (nilChain/Cosmos)](/community/guides/nillion-wallet) guide to set up a connected wallet. After creating a wallet, you should have a nilChain wallet address similar to this example address:
...
### 2. Add your nilChain Testnet wallet address.

    1. Open the Keplr extension and click "Copy address."

    2. Search for "Nillion Testnet"

    3. Click the copy icon next to "Nillion Testnet" to copy your nilChain Testnet wallet address.

    4. Paste your nilChain Testnet wallet address into the faucet.
...
Complete the verification challenge and then click "Continue." The faucet will send testnet NIL to your nilChain Testnet wallet address.

### 4. Check your wallet for a NIL balance

Open your wallet to see the NIL in your nilChain Testnet wallet.
