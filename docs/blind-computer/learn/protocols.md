...
The Nillion Network [Blind Modules](/blind-computer/learn/blind-modules) -- and the available SDKs that can be used to interoperate with them -- make it possible to leverage a number of secure data storage and computation protocols. These include what are broadly known as privacy-enhancing technologies (PETs).
...
[Private LLM inference](/blind-computer/build/llms/overview) and the use of [private RAG](/blind-computer/build/llms/nilRAG) is supported via TEEs.
