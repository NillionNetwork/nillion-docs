...
Nillion is building a **blind computer** - a decentralized network of nodes that stores and processes your and your users' most sensitive data while keeping it encrypted and private from application backends and the operators running the underlying infrastructure.
