...
Now we need to set `NILLION_API_KEY` using the API KEY from the Developer Portal.

<CTABanner
  question='Get your nilAI API key here'
  instruction='Visit the Developer Portal and create a API key'
  buttonText='Get your key'
  buttonLink='https://developer.nillion.com/nilai'
...
3. Uses model `google/gemma-4-26B-A4B-it`.
