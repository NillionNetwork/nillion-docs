...
<CTABanner
  ...
  instruction='Visit the Developer Portal and create a Public DID / Private Key'
...
With OpenAI compatibility, you can use any OpenAI library. Here's an example for querying the `google/gemma-4-26B-A4B-it` model:
