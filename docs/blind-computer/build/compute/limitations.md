...
The restrictions described above ensure the below properties.
...
Despite the enumerated restrictions, developers still have the option to do any of the below.
