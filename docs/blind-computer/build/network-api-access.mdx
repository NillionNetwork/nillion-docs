...
![nilPay Choose Recipient](/img/nilpay-identity-explainer.png)
...
Note: Your address may appear as `did:ethr:0xXXX`. This is a DID (Decentralized Identifier) — a unique cryptographic identifier derived from your public key, used for verifiable authentication.
