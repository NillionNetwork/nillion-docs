...
Build a Node.js script that reads all records from a [Nillion Private Storage](/blind-computer/build/storage/overview) standard collection with full TypeScript support!
