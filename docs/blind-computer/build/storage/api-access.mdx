...
The nilPay Subscription Portal allows you to subscribe and create credentials for using the [Private Storage](/blind-computer/build/storage/overview) network APIs and SDK.
...
Click on the either `Purchase` for `nilDB` to subscribe and follow the wallet prompts.
